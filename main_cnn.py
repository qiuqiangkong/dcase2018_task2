...
def inference_validation(args):
    ...
    # Data generator
    generator = Generator(hdf5_path=tr_hdf5_path, batch_size=None, time_steps=None, verified_only=False, validation=True)
    ...
    for (slice_x, slice_y, audio_name) in generator.generate_validate_slices():
